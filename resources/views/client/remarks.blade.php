          ...
          <div class="content-wrapper">
            ...
            <div class="row">
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title text-center">Project Remarks </h4>
                    <form class="forms-sample" action="{{route('create_project_remarks')}}" method="POST">
                        @csrf
                      <div class="form-group">
                        <input type="hidden" value="{{$id}}" name="id">
                        <label for="exampleTextarea1">Remarks</label>
                        <textarea class="form-control" id="exampleTextarea1" name="remarks" rows="4" placeholder=" Please Write Here "></textarea>
                      </div>
                      <button type="submit" class="btn btn-primary w-100 mr-2">Submit</button>
                    </form>
                  </div>
                </div>
              </div>

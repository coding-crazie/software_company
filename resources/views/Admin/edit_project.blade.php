                ...
                <div class="col-12 grid-margin stretch-card">
                    <div class="card">
                      <div class="card-body">
                        ...
                        <form class="forms-sample" action="{{route('update_project')}}" method="POST">
                            @csrf
                                ...
                                <div class="form-group">
                                  ...
                                  <input type="text" name="progress" value="{{$project_detail->progress}}" required class="form-control" id="exampleInputName1" placeholder="Your Progress">
                                </div>
                          @if ($errors->has('email'))
                      ...
                      @endif
                          ...
                          <div class="form-group">
                            ...
                            <input class="form-control"  type="text" id="exampleTextarea1" value="{{$project_detail->description}}" name="description" rows="4" placeholder=" All Project Details "></input>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <select  name="client" class="form-control form-control-lg" id="exampleFormControlSelect1">
                              ...
                              <option value="{{$project_detail->client}}">{{$project_detail->client}}</option>
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" value="{{$project_detail->amount}}" name="amount" required class="form-control" id="exampleInputName1" placeholder="Selected Method Name">
                          </div>


                             <div class="form-group">
                            <label for="exampleInputName1">Payment Method</label>
                            <input type="text" value="{{$project_detail->payment_method}}" name="payment" required class="form-control" id="exampleInputName1" placeholder="Selected Method Name">
                          </div>

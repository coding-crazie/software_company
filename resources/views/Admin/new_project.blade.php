          ...
          <div class="content-wrapper">
            ...
            <div class="row">
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title text-center">     Register New Project </h4>
                    <p class="card-description text-center" style="color:red"> Must Type All Important Fields </p>
                    <form class="forms-sample" action="{{route('create_project')}}" method="POST">
                        @csrf
                      <div class="form-group">
                        <label for="exampleInputName1">Name</label>
                        <input type="text" name="name" required class="form-control" id="exampleInputName1" placeholder="Name Of Project">
                      </div>
                      @if ($errors->has('email'))
                  ...
                  @endif
                      ...
                      <div class="form-group">
                        ...
                        <textarea class="form-control" id="exampleTextarea1" name="description" rows="4" placeholder=" All Project Details "></textarea>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="amount" required class="form-control" id="exampleInputName1" placeholder="Amount Of Project">
                      </div>

                      <div class="form-group">
                        <label for="exampleInputName1">Payment Method</label>
                        <input type="text" name="payment" required class="form-control" id="exampleInputName1" placeholder="Selected Method Name">
                      </div>

...
<tr>
<td>
<table align="center" border="0" cellpadding="0" cellspacing="0" class="row-content stack" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-repeat: no-repeat; background-position: center top; color: #000000; background-image: url('{{ asset('images/glow_3.png') }}'); width: 600px; margin: 0 auto;" width="600">
<tbody>
<tr>
...
<div style="max-width: 150px;"><img alt="Books Plus" src="{{ asset('images/book-plus.png') }}" style="display: block; height: auto; border: 0; width: 100%;" title="Books Plus" width="150"/></div>
</div>
</td>
</tr>
</table>
...
<div align="center" class="alignment" style="line-height:10px">
<div class="fullWidth" style="max-width: 600px;"><img src="{{ asset('images/top-rounded.png') }}" style="display: block; height: auto; border: 0; width: 100%;" width="600"/></div>
</div>
</td>
</tr>
</table>
...
<div align="center" class="alignment" style="line-height:10px">
<div class="fullWidth" style="max-width: 600px;"><img alt="book shelf" src="{{ asset('images/block2.png') }}" style="display: block; height: auto; border: 0; width: 100%;" title="book shelf" width="600"/></div>
</div>
</td>
</tr>
</table>
...
<table align="center" border="0" cellpadding="0" cellspacing="0" class="row row-3" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #ff7d14; background-image: url('{{ asset('images/orange-gradient-wide.png') }}'); background-repeat: no-repeat;" width="100%">
<tbody>
<tr>
<td>
...
<h1 style="margin: 0; color: #555555; direction: ltr; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; font-size: 36px; font-weight: normal; letter-spacing: normal; line-height: 120%; text-align: center; margin-top: 0; margin-bottom: 0; mso-line-height-alt: 43.199999999999996px;"><strong>Welcome to Software </strong></h1>
</td>
</tr>
</table>
...
<p style="margin: 0; word-break: break-word;">{{$details['name']}} </p>
</div>
</td>
</tr>
</table>
...
<tr>
<td class="pad" style="padding-bottom:5px;padding-top:25px;text-align:center;width:100%;">
<h2 style="margin: 0; color: #555555; direction: ltr; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; font-size: 24px; font-weight: normal; letter-spacing: normal; line-height: 120%; text-align: center; margin-top: 0; margin-bottom: 0; mso-line-height-alt: 28.799999999999997px;">Best regards</h2>
</td>
</tr>
</table>
<table border="0" cellpadding="0" cellspacing="0" class="paragraph_block block-2" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;" width="100%">
...
<td class="pad" style="padding-bottom:20px;padding-left:30px;padding-right:30px;padding-top:20px;">
<div style="color:#737487;font-family:Arial, Helvetica Neue, Helvetica, sans-serif;font-size:18px;line-height:180%;text-align:center;mso-line-height-alt:32.4px;">
<p style="margin: 0; word-break: break-word;">"From Admin"</p>
</div>
</td>
</tr>
</table>
...
<div align="center" class="alignment" style="line-height:10px">
<div style="max-width: 541px;"><img src="{{ asset('images/divider.png') }}" style="display: block; height: auto; border: 0; width: 100%;" width="541"/></div>
</div>
</td>
</tr>
</table>
...
<tr>
<td style="padding:0 7px 0 7px;"><a href="https://www.facebook.com" target="_blank"><img alt="Facebook" height="32" src="{{ asset('images/facebook2x.png') }}" style="display: block; height: auto; border: 0;" title="Facebook" width="32"/></a></td>
<td style="padding:0 7px 0 7px;"><a href="https://www.twitter.com" target="_blank"><img alt="Twitter" height="32" src="{{ asset('images/twitter2x.png') }}" style="display: block; height: auto; border: 0;" title="Twitter" width="32"/></a></td>
<td style="padding:0 7px 0 7px;"><a href="https://www.instagram.com" target="_blank"><img alt="Instagram" height="32" src="{{ asset('images/instagram2x.png') }}" style="display: block; height: auto; border: 0;" title="Instagram" width="32"/></a></td>
</tr>
</table>
</div>
</td>
...
<td class="pad" style="width:100%;padding-right:0px;padding-left:0px;">
<div align="center" class="alignment" style="line-height:10px">
<div class="fullWidth" style="max-width: 600px;"><img src="{{ asset('images/bottom-rounded.png') }}" style="display: block; height: auto; border: 0; width: 100%;" width="600"/></div>
</div>
</td>
</tr>
</table>

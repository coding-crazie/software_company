    ...
    <ul class="nav">
      ...
      <li class="nav-item menu-items">
        ...
        <div class="collapse" id="project">
          <ul class="nav flex-column sub-menu">
            ...
            <li class="nav-item"> <a class="nav-link" href="/quote">New Project</a></li>
          </ul>
        </div>
      </li>
      ...
      <li class="nav-item menu-items">
        ...
        <div class="collapse" id="Tickets">
          <ul class="nav flex-column sub-menu">
            ...
            <li class="nav-item"> <a class="nav-link" href="/My-New-Ticket">New Ticket </a></li>
          </ul>
        </div>
      </li>
      ...
      <li class="nav-item menu-items">
        ...
        <div class="collapse" id="Emails">
          <ul class="nav flex-column sub-menu">
            <li class="nav-item"> <a class="nav-link" href="https://api.whatsapp.com/send?phone=923207231005&text=Hello,%20I%20have%20a%20question.">Whatsapp </a></li>
            <li class="nav-item"> <a class="nav-link" href="/Admin-Mail-Box">Skype</a></li>
            <li class="nav-item"> <a class="nav-link" href="/contact">Contact Mail </a></li>
          </ul>
        </div>
      </li>
